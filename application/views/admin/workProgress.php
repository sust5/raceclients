		...
		<div class="row pt-2 pb-2">
			...
			<div class="col-sm-3">
				<div class="btn-group float-sm-right">
					<a href="<?php echo base_url();?>index.php/admin/addworkprogress" class="btn btn-outline-primary waves-effect waves-light">Add Work Progress</a>
				</div>
			</div>
		</div>
		<!-- End Breadcrumb-->
						...
						<tbody>
							<?php  $i=1;foreach($Worklist as $use){ ?>
								<tr>
									...
									<td><?php  echo $use->work_des_title ?></td>
									<td><?php echo $use->wp_desc; ?></td>
									<td><?php echo $use->complete_percent; ?>%</td>
									<td><a class="btn btn-primary" href="<?php echo base_url();?>index.php/admin/editworkprogress?id=<?php echo $use->id;?>" >edit &nbsp;&nbsp;<i class="fa fa-pencil-square-o"></i></a>
										<hr>
										<a class="btn btn-danger" href="javaScript:void(0)"  onclick="delete_record('<?php echo $use->id; ?>','work_progress')" >delete &nbsp;&nbsp;<i class="fa fa-trash"></i></a>
