		...
		<div class="row">
			<div class="col-lg-10 mx-auto">
                ...
                <div class="form-group">
                  ...
                  <input type="text" required value="" class="form-control" name="description" id="input-1" >
                </div>
                <div class="form-group">
                  <label for="input-1">complete percent</label>
                  <input type="text" required value="" class="form-control" name="complete_percent" id="input-1" >
                </div>
                <div class="form-group">
									<label for="input-4">work</label>
									<!-- DropDown -->
									<select name="work_id" required  class="form-control">
										<option value="">Select work</option>
                    <?php foreach ($workList as $key => $value): ?>
                      <?php echo "<option required value=  '$value->id'>"?>  <?php echo  $value->work_title;?></option>
                    <?php endforeach; ?>
			...
			<script type="text/javascript">
				...
				function saveWork(){
					...
					$.ajax({
						type:'POST',
						url:'<?php echo base_url(); ?>index.php/admin/saveWorkProgress',
						data:formData,
						cache:false,
						contentType: false,
						processData: false,
