...
<div class="content-wrapper">
	<div class="container-fluid">
		...
		<div class="row pt-2 pb-2">
			<div class="col-sm-9">
				<h4 class="page-title">Homepage gallery</h4>
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="javaScript:void();">Homepage gallery</a></li>
					<li class="breadcrumb-item"><a href="javaScript:void();">Update Homepage gallery</a></li>
				</ol>
			</div>
				...
				<div class="card">
					<div class="card-body">
						...
						<ul class="nav nav-pills nav-pills-danger nav-justified top-icon" role="tablist">
							<li class="nav-item">
								<a class="nav-link active show" data-toggle="pill" href="#piil-17"><i class="fa fa-picture-o"></i> <span class="hidden-xs">Add Image for Homepage gallery</span></a>
							</li>
							<li class="nav-item">
								<a class="nav-link" data-toggle="pill" href="#piil-20"><i class="fa fa-pencil-square-o"></i> <span class="hidden-xs">Update Image for Homepage gallery</span></a>
							</li>
			...
			<div class="card-body">
				<div class="table-responsive">
					<table id="default-datatable" class="table table-bordered">
						...
						<tbody>
							<?php  $i=1;foreach($wg_list as $use){ ?>
								<tr>
									<td><?php echo $use->wg_id;?></td>
									<td><?php echo $use->wg_title; ?></td>
									<td><img src="<?php echo base_url().$use->wg_url; ?>" height="250px" width="250px"></td>
									<td><?php  echo $use->wg_date; ?></td>
									<td>
										<a class="btn btn-danger" href="javaScript:void(0)"  onclick="delete_record('<?php echo $use->wg_id; ?>','website_gallery')" >delete &nbsp;&nbsp;<i class="fa fa-trash"></i></a>
										<input type="hidden" name="status_change" id="status_change_user<?php echo $use->wg_id; ?>" value="<?php echo $use->wg_id; ?>">
									</td>
								</tr>
								<?php $i++;} ?>
		...
		<script>
			...
			function saveGalary(){
				...
				$.ajax({
					type:'POST',
					url:'<?php echo base_url(); ?>index.php/admin/saveWG',
					data:formData,
					dataType: "json",
					cache:false,
					contentType: false,
