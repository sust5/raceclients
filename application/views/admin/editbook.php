...
<div class="content-wrapper">
	...
	<div class="form-group">
									<label for="input-3"> Semester</label>
									<!-- DropDown -->
									<select name="select_Sem" required  class="form-control">
										<option value="">Select Semester</option>
										<?php foreach($semlist as $cat){ ?>
											<option  value="<?php echo $cat->sem_id; ?>
											"<?php if($cat->sem_id==$vid->fs_id ){ echo 'selected="selected"'; } ?> ><?php echo $cat->sem_name; ?></option>          
											<?php ;
										} ?>
										</select>
									</div>
	<div class="form-group">
									...
									<select name="select_course" required  class="form-control">
										...
										<?php foreach($courselist as $cat){ ?>
											<option required value="<?php echo $cat->course_id; ?>"<?php if($cat->course_id==$vid->fc_id ){ echo 'selected="selected"'; } ?>><?php echo $cat->course_name; ?></option>            
											<?php } ?>
										</select>
									</div>
